...
function CreateItemButtons(scene) {
    ...
    //button shield
    {
        ...
        const item = centerData.inventoryDictionary[code];
        if (item) {
    ...
    //button energy
    {
        ...
        function OnButtonDown() {
            // console.log("OnButtonDown DOGE_ENERGY quantity:", quantity);
            // console.log("OnButtonDown DOGE_ENERGY btn.locked:", btn.locked);

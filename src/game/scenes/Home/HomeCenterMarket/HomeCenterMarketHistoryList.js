...
let container_history_main_sub = null;

let container_history_cat_buttons = null;
...
export { container_history_main_sub };

export function CreateCenterMarketHistoryList(scene) {
    //console.log("CreateCenterMarketHistoryList");
    ...
    container_history_main_sub = scene.add.container(0, 0);
    container_main.add(container_history_main_sub);

    container_history_cat_buttons = scene.add.container(0, 0);
    container_main.add(container_history_cat_buttons);
...
function ActiveItem(scene) {
    ...
    CreateCenterMarketHistoryListItem(scene);
...
function ActiveCharacter(scene) {
    ...
    CreateCenterMarketHistoryListCharacter(scene);
    CloseItem(scene);
    CloseMSCI(scene);
}
...
function ActiveMSCI(scene) {
    ...
    CreateCenterMarketHistoryListMSCI(scene);
    CloseItem(scene);
    CloseCharacter(scene);
}
...
function CreateCatButton(scene, x, y, buttonName) {
    ...
    container_history_cat_buttons.add(btn_container);
...
function Destroy(scene) {
    ...
    //console.log("HomeCenterMarketHistoryList Destroy");
}

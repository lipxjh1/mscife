...
import { CreateCenterMarketCharacterSelectedDetail } from "./HomeCenterMarketMainCharacterSelectedDetail.js";
import {
    CreateCenterMarketCharacterStar,
    GetCountByStarLevel,
} from "./HomeCenterMarketMainCharacterStar.js";
...
export function CreateCenterMarketCharacterSelected(
    scene,
    roleKey,
    codeKey,
    starKey
...
function CreateCharacterList(scene) {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        let count = GetCountByStarLevel(selectedStar, level);
...
export function Close(scene) {
    ...
    //console.log("HomeCenterMarketMainCharacterSelected Close");

    CreateCenterMarketCharacterStar(scene, selectedRole, selectedCode);
}
...
export function Destroy(scene) {
    ...
    //console.log("HomeCenterMarketMainCharacterSelected Destroy");
}

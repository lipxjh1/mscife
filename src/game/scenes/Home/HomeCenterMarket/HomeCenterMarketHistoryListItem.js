...
export function CreateCenterMarketHistoryListItem(scene) {
    //console.log("CreateCenterMarketHistoryListItem");
...
function createHistoryItem(scene, itemWidth, itemHeight) {
    ...
    container.updateContent = function (data) {
        ...
        let itemLocalData = centerDataItem.getItemById(data.itemCode);

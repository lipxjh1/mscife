...
import { Destroy as DestroyCharacterCode } from "./HomeCenterMarketMainCharacterCode.js";

import { Destroy as DestroyCharacterStar } from "./HomeCenterMarketMainCharacterStar.js";

import { Destroy as DestroyCharacterSelected } from "./HomeCenterMarketMainCharacterSelected.js";
...
export function CreateCenterMarketCharacterRole(scene) {
...
function CreateCharacterList(scene) {
    ...
    for (let i = 0; i < roleKeys.length; i++) {
        ...
        container_item.button_buy.button.on("pointerdown", function () {
            CreateCenterMarketCharacterCode(scene, roleKey);

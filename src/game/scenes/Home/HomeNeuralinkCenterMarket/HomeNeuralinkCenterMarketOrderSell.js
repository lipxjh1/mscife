...
import {
    CreateNeuralinkCenterMarketOrderSellItems,
    Close as CloseNeuralink,
} from "./HomeNeuralinkCenterMarketOrderSellItems.js";
...
let container_center_market_order_sell = null;

let container_center_market_order_sell_sub = null;

let container_center_market_order_sell_cat_buttons = null;
...
export { container_center_market_order_sell_sub };

export function CreateNeuralinkCenterMarketOrderSell(scene) {
    //console.log("CreateNeuralinkCenterMarketOrderSell");

    isOpen = false;

    container_center_market_order_sell = scene.add.container(0, 0);
    container_center_market_order_sub.add(container_center_market_order_sell);

    container_center_market_order_sell_sub = scene.add.container(0, 0);
    container_center_market_order_sell.add(
        container_center_market_order_sell_sub
    );

    container_center_market_order_sell_cat_buttons = scene.add.container(0, 0);
    container_center_market_order_sell.add(
        container_center_market_order_sell_cat_buttons
    );
...
function ActiveItem(scene) {
    ...
    CreateNeuralinkCenterMarketOrderSellItems(scene);
...
function CreateCatButton(scene, x, y, buttonName) {
    ...
    container_center_market_order_sell_cat_buttons.add(btn_container);
...
function Destroy(scene) {
    container_center_market_order_sell.destroy();
}

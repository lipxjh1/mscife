...
import { GetItemTypeContainerMain } from "./HomeNeuralinkCenterMarketItemsType.js";
...
export function CreateNeuralinkCenterMarketItemsConnected(scene, matchStr) {
    //console.log("CreateNeuralinkCenterMarketItems");
...
function CreateItemList(scene, receivedData) {
    ...
    for (let i = 0; i < receivedData.data.length; i++) {
        ...
        receivedDict[itemData.assetIdentifier] = itemData;
    }
    ...
    for (let i = 0; i < itemCodes.length; i++) {
        ...
        if (itemData != null) {
            quantity = itemData.totalQuantityBeingSold;
        }

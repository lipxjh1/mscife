...
import { container_center_market_buy_sub } from "./HomeNeuralinkCenterMarketBuy.js";
...
export function CreateNeuralinkCenterMarketItemsType(scene) {
    ...
    container_center_market_buy_sub.add(container_main);
...
function CreateItemList(scene, data_arr) {
    ...
    container_connected.button_sell.button.on("pointerdown", function () {
        CreateNeuralinkCenterMarketItemsConnected(
            scene,
            "CONNECTED_NEURALINK_"
        );
    ...
    container_elite.button_sell.button.on("pointerdown", function () {
        CreateNeuralinkCenterMarketItemsConnected(scene, "ELITE_NEURALINK_");

...
import { container_center_market_order_buy_sub } from "./HomeNeuralinkCenterMarketOrderBuy.js";

let container_main = null;

let isOpen = false;

export function CreateNeuralinkCenterMarketOrderBuyItems(scene) {
    Destroy(scene);
...
function RequestOrderSellList(scene) {
    ...
    centerData.RequestNeuralinkCenterMarketItemOrderBookBuy(
        (result) => {
            HideLoadingPopup();

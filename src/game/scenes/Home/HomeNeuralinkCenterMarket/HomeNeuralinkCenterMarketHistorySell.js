...
export function CreateNeuralinkCenterMarketHistorySell(scene) {
    //console.log("CreateNeuralinkCenterMarketHistorySell");
...
function RequestOrderSellList(scene) {
    ...
    centerData.RequestNeuralinkCenterMarketItemHistorySell(
        currentPage,
        (result) => {
            HideLoadingPopup();

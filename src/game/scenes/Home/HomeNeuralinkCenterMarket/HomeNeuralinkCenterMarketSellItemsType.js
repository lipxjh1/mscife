...
import { CreateNeuralinkCenterMarketSellItemsConnected } from "./HomeNeuralinkCenterMarketSellItemsConnected.js";
...
export function CreateNeuralinkCenterMarketSellItemsType(scene) {
    //console.log("CreateNeuralinkCenterMarketSellItemsType");
...
function CreateItemList(scene, data_arr) {
    ...
    container_connected.button_sell.button.on("pointerdown", function () {
        CreateNeuralinkCenterMarketSellItemsConnected(
            scene,

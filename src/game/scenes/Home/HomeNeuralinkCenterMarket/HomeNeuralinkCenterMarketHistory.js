...
import {
    CreateNeuralinkCenterMarketHistorySell,
    Close as CloseListHistory,
} from "./HomeNeuralinkCenterMarketHistorySell.js";

import {
    CreateNeuralinkCenterMarketHistoryBuy,
    Close as CloseOrderHistory,
} from "./HomeNeuralinkCenterMarketHistoryBuy.js";
...
export function CreateNeuralinkCenterMarketHistory(scene) {
    //console.log("CreateNeuralinkCenterMarketHistory");
...
function ActiveBuy(scene) {
    ...
    CreateNeuralinkCenterMarketHistoryBuy(scene);
...
function ActiveSell(scene) {
    ...
    CreateNeuralinkCenterMarketHistorySell(scene);

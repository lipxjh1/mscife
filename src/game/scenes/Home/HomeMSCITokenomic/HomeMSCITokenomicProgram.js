...
import { CreateMSCITokenomicProgramDetail } from "./HomeMSCITokenomicProgramDetail.js";
...
export function CreateMSCITokenomicProgram(scene, categories) {
    Destroy();
...
function CreateListItem(scene, scrollablePanel, transaction) {
    ...
    item.setInteractive({ useHandCursor: true }) // Thiết lập tương tác và đổi thành hình bàn tay khi hover
        ...
        .on("pointerup", function (pointer) {
            ...
            if (duration <= 200) {
                CreateMSCITokenomicProgramDetail(scene, transaction.view_slug);
            }
        })
    ...
    const text_type = scene.add
        .text(139, 30, item.transaction.name, {
    ...
    const text_total = scene.add
        .text(139, 75, "Total $MSCI: " + item.transaction.total, {
            fontFamily: "Russo One",
            fontSize: "24px",
            color: "#CCCCCC",
            align: "left",
        ...
        .setOrigin(0, 0);
    container_inner.add(text_total);

    const text_disbursed = scene.add
        .text(139, 120, "Release $MSCI: " + item.transaction.disbursed, {
            fontFamily: "Russo One",
            fontSize: "24px",
            color: "#CCCCCC",
            align: "left",
        ...
        .setOrigin(0, 0);
    container_inner.add(text_disbursed);

    // const text_chip = scene.add
    //     .text(900, 30, "Chip: " + item.transaction.chipAmountConverted, {
    //         fontFamily: "Russo One",
    //         fontSize: "24px",
    //         color: "#CCCCCC",
    //         align: "right",
    ...
    //     .text(900, 75, "MSCI: " + item.transaction.msciAmountReceived, {
    //         fontFamily: "Russo One",
    //         fontSize: "24px",
    //         color: "#CCCCCC",
    //         align: "right",

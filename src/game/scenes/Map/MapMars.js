...
class MapMars extends Map {
    constructor(scene, id) {
        super(scene, id); // Gọi constructor của lớp cha
        this.initMarsMap(); // Khởi tạo logic cho MapSpace
...
export function CreateMap(scene, id) {
    return new MapMars(scene, id);
}

export default MapMars;

...
class MapBoss extends Map {
    constructor(scene, id) {
        super(scene, id); // Gọi constructor của lớp cha
        this.initSpaceMap(); // Khởi tạo logic cho MapBoss

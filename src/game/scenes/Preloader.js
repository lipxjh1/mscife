...
console.log('[Preloader] Example asset URL:', assetsBaseUrl + 'load/load_bg.webp');
...
export function LoadPreloader(scene) {
    ...
    scene.load.image(
        "load_slider_bg",
        assetsBaseUrl + "load/load_slider_bg.webp"
    );
    scene.load.image(
        "load_slider_fill",
        assetsBaseUrl + "load/load_slider_fill.webp"
    );

    scene.load.image(
        "load_loading_circle_bg",
        assetsBaseUrl + "load/load_loading_circle_bg.webp"
    );

    scene.load.image(
        "load_loading_circle",
        assetsBaseUrl + "load/load_loading_circle.webp"
    );
    ...
    scene.load.audio(
        "audio_background",
        assetsBaseUrl + "audio/audio_background/audio_background.mp3"
    );

    //load player sfx
    scene.load.audio(
        "audio_gun_shot",
        assetsBaseUrl + "audio/audio_gun/audio_gun_shot.wav"
    );

    //load player sfx
    scene.load.audio(
        "audio_sniper_shot",
        assetsBaseUrl + "audio/audio_gun/audio_sniper_shot.wav"
    );

    //load player sfx
    scene.load.audio(
        "audio_rocket_shot",
        assetsBaseUrl + "audio/audio_gun/audio_rocket_shot.wav"
    );
    ...
    scene.load.audio(
        "player_0_voice",
        assetsBaseUrl + "audio/audio_player/audio_player_0/player_0_voice.mp3"
    );
}
...
export function LoadShare(scene) {
    ...
    scene.load.image(
        "share_btn_home_2",
        assetsBaseUrl + "share_2/share_btn_home_2.webp"
    );

    scene.load.image(
        "share_btn_back",
        assetsBaseUrl + "share_2/share_btn_back.webp"
    );

    //load share alert popup
    scene.load.image(
        "share_popup_alert_bg",
        assetsBaseUrl + "share_2/share_popup_alert/share_popup_alert_bg.webp"
    );

    scene.load.image(
        "share_popup_alert_btn",
        assetsBaseUrl + "share_2/share_popup_alert/share_popup_alert_btn.webp"
    );

    //load share input popup
    scene.load.image(
        "share_popup_input_bg",
        assetsBaseUrl + "share_2/share_popup_input/share_popup_input_bg.webp"
    );

    scene.load.image(
        "share_popup_input_bg_2",
        assetsBaseUrl + "share_2/share_popup_input/share_popup_input_bg_2.webp"
    );

    scene.load.image(
        "share_popup_buy_bg",
        assetsBaseUrl + "share_2/share_popup_input/share_popup_buy_bg.webp"
    );

    scene.load.image(
        "share_popup_input_btn",
        assetsBaseUrl + "share_2/share_popup_input/share_popup_input_btn.webp"
    );

    scene.load.image(
        "share_popup_input_btn_1",
        assetsBaseUrl + "share_2/share_popup_input/share_popup_input_btn_1.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "share_2/share_btn_signin_google.webp"
    );
...
export function LoadLogin(scene) {
    //Load player bar
    scene.load.image("login_bg", assetsBaseUrl + "login/login_bg.webp");

    scene.load.image("login_btn_0", assetsBaseUrl + "login/login_btn_0.webp");

    scene.load.image("login_btn_1", assetsBaseUrl + "login/login_btn_1.webp");

    scene.load.image("login_btn_3", assetsBaseUrl + "login/login_btn_3.webp");

    // NEW: Load Vorld logo for login button
    scene.load.image("vorld_logo", assetsBaseUrl + "icons/vorld.webp");
}
...
export function LoadGameplay(scene) {
    scene.load.image(
        ...
        assetsBaseUrl + "gameplay/gameplay_enemy_attack_warning.webp"
    );
    //Crosshair
    scene.load.image(
        "player_crosshair_gunner",
        assetsBaseUrl + "gameplay/player/player_crosshair_gunner.webp"
    );
    scene.load.image(
        "player_crosshair_rocket",
        assetsBaseUrl + "gameplay/player/player_crosshair_rocket.webp"
    );
    scene.load.image(
        "player_crosshair_sniper",
        assetsBaseUrl + "gameplay/player/player_crosshair_sniper.webp"
    );
    scene.load.image(
        "player_shield",
        assetsBaseUrl + "gameplay/player/player_shield.webp"
    );
    scene.load.image(
        "skill_shoot_all",
        assetsBaseUrl + "gameplay/skill_shoot_all.webp"
    );
    scene.load.image(
        "skill_invisible_all",
        assetsBaseUrl + "gameplay/skill_invisible_all.webp"
    );
...
export function LoadGameplayUI(scene) {
    ...
    scene.load.spritesheet(
        ...
        assetsBaseUrl + "gameplay/enemy/enemy_fx/enemy_fx_strike_anim.webp",
        {
            frameWidth: 500,
            frameHeight: 500,
        }
    ...
    scene.load.spritesheet(
        "enemy_fx_explosion",
        assetsBaseUrl + "gameplay/enemy/enemy_fx/enemy_fx_explosion.webp",
        {
            frameWidth: 140,
            frameHeight: 180,
        }
    ...
    scene.load.image(
        "enemy_fx_shield",
        assetsBaseUrl + "gameplay/enemy/enemy_fx/enemy_fx_shield.webp"
    );

    // Tải reward items
    scene.load.image(
        "home_battle_item_reward_bg",
        assetsBaseUrl + "home_2/home_battle/home_battle_item_reward_bg.webp"
    );
...
export function LoadEnemyByRange(scene, enemyRange) {
    switch (enemyRange) {
        case "earth": // Stage 1-20
            ...
            scene.load.spine(
                "gameplay_enemy_0",
                assetsBaseUrl + "gameplay/enemy/enemy_0/enemy_0.json",
                assetsBaseUrl + "gameplay/enemy/enemy_0/enemy_0.atlas",
                true
            );
            scene.load.spine(
                "gameplay_enemy_1",
                assetsBaseUrl + "gameplay/enemy/enemy_1/enemy_1.json",
                assetsBaseUrl + "gameplay/enemy/enemy_1/enemy_1.atlas",
                true
            );
            scene.load.spine(
                "enemy_drone_0",
        ...
        case "space": // Stage 21-40
            ...
            scene.load.spine(
                "gameplay_enemy_2",
                assetsBaseUrl + "gameplay/enemy/enemy_2/play_drone_0.json",
                assetsBaseUrl + "gameplay/enemy/enemy_2/play_drone_0.atlas",
                true
            );
            scene.load.spine(
                "enemy_drone_3",
        ...
        case "mars": // Stage 41-60
            ...
            scene.load.spine(
                "enemy_ghost_0",
                assetsBaseUrl + "gameplay/enemy/enemy_ghost_0/player_15.json",
                assetsBaseUrl + "gameplay/enemy/enemy_ghost_0/player_15.atlas",
                true
            );
            break;
...
export function LoadBossAssets(scene) {
    ...
    scene.load.image(
        "map_boss_0_bg",
        assetsBaseUrl + "gameplay/map/map_boss_0/map_boss_0_bg.webp"
    );
    scene.load.image(
    ...
    scene.load.spine(
        ...
        assetsBaseUrl + "gameplay/enemy/enemy_boss_0/enemy_elite_1.json",
        assetsBaseUrl + "gameplay/enemy/enemy_boss_0/enemy_elite_1.atlas",
        true
    );

    scene.load.spine(
        "gameplay_enemy_boss_1",
        assetsBaseUrl + "gameplay/enemy/enemy_boss_1/player_19.json",
        assetsBaseUrl + "gameplay/enemy/enemy_boss_1/player_19.atlas",
        true
    );

    scene.load.image(
        "gameplay_enemy_boss_2",
        assetsBaseUrl + "gameplay/enemy/enemy_boss_2/gameplay_enemy_boss_2.webp"
    );
    ...
    scene.load.spine(
        "enemy_drone_0",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_0/play_drone_2.json",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_0/play_drone_2.atlas",
        true
    );
    scene.load.spine(
        "enemy_drone_1",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_1/play_drone_3.json",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_1/play_drone_3.atlas",
        true
    );
    scene.load.spine(
        "enemy_drone_2",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_2/play_drone_4.json",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_2/play_drone_4.atlas",
        true
    );
}
...
export function LoadPlayerBar(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_top_bar_player/home_top_bar_player_bg.webp"
    );
...
export function LoadPlayerCurrency(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_top_currency/home_top_currency_bg.webp"
    );
    scene.load.image(
        "home_top_currency_chip_1",
        assetsBaseUrl + "home_2/home_top_currency/home_top_currency_chip_1.webp"
    );
    scene.load.image(
        "home_top_currency_chip_2",
        assetsBaseUrl + "home_2/home_top_currency/home_top_currency_chip_2.webp"
    );
}
...
export function LoadReward(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_mission.webp"
    );

    scene.load.image(
        "home_reward_btn_achivement",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_achivement.webp"
    );

    scene.load.image(
        "home_reward_btn_airdrop",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_airdrop.webp"
    );

    scene.load.image(
        "home_reward_cat_button",
        assetsBaseUrl + "home_2/home_reward/home_reward_cat_button.webp"
    );

    scene.load.image(
        "home_reward_btn_go",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_go.webp"
    );

    scene.load.image(
        "home_reward_btn_claim",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_claim.webp"
    );

    scene.load.image(
        "home_reward_btn_invite",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_invite.webp"
    );

    scene.load.image(
        "home_reward_btn_invite_link",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_invite_link.webp"
    );

    scene.load.image(
        "home_reward_btn_locked",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_locked.webp"
    );

    scene.load.image(
        "home_reward_btn_unlocked",
        assetsBaseUrl + "home_2/home_reward/home_reward_btn_unlocked.webp"
    );

    scene.load.image(
        "home_reward_item_bg",
        assetsBaseUrl + "home_2/home_reward/home_reward_item_bg.webp"
    );

    scene.load.image(
        "home_reward_checked",
        assetsBaseUrl + "home_2/home_reward/home_reward_checked.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_reward/home_reward_airdrop_thanks_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_reward/home_reward_airdrop_icon_dogs.webp"
    );

    scene.load.image(
        "home_reward_airdrop_icon_x",
        assetsBaseUrl + "home_2/home_reward/home_reward_airdrop_icon_x.webp"
    );

    scene.load.image(
        "home_reward_airdrop_icon_seed",
        assetsBaseUrl + "home_2/home_reward/home_reward_airdrop_icon_seed.webp"
    );

    scene.load.image(
        "home_reward_airdrop_icon_pi",
        assetsBaseUrl + "home_2/home_reward/home_reward_airdrop_icon_pi.webp"
    );
...
export function LoadGacha(scene) {
    ...
    scene.load.image(
        "home_gacha_bg",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_bg.webp"
    );

    // load title
    scene.load.image(
        "home_gacha_mode_title",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_mode_title.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_gacha/home_gacha_btn_recuit_1.webp"
    );

    scene.load.image(
        "home_gacha_btn_spin_1",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_btn_spin_1.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_david.webp"
    );

    scene.load.image(
        "home_gacha_char_henry",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_henry.webp"
    );

    scene.load.image(
        "home_gacha_char_marcus",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_marcus.webp"
    );

    scene.load.image(
        "home_gacha_char_anna",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_anna.webp"
    );

    scene.load.image(
        "home_gacha_char_julia",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_julia.webp"
    );

    scene.load.image(
        "home_gacha_char_fiona",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_fiona.webp"
    );

    scene.load.image(
        "home_gacha_char_victoria",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_victoria.webp"
    );

    scene.load.image(
        "home_gacha_char_elizabeth",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_elizabeth.webp"
    );

    scene.load.image(
        "home_gacha_char_alexandra",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_alexandra.webp"
    );

    scene.load.image(
        "home_gacha_char_akane",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_akane.webp"
    );

    scene.load.image(
        "home_gacha_char_alice",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_alice.webp"
    );

    scene.load.image(
        "home_gacha_char_caitlyn",
        assetsBaseUrl + "home_2/home_gacha/home_gacha_char_caitlyn.webp"
    );
}
...
export function LoadShopInventory(scene) {
    ...
    scene.load.spine(
        "x_force_box",
        assetsBaseUrl + "home_2/home_inventory_shop/x_force_box.json",
        assetsBaseUrl + "home_2/home_inventory_shop/x_force_box.atlas",
        true
    );
}
...
export function LoadCenterMarket(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_center_market/home_center_market_bg.webp"
    );
...
export function LoadNotification(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_notification/home_notification_bg.webp"
    );

    scene.load.image(
        "home_notification_title",
        assetsBaseUrl + "home_2/home_notification/home_notification_title.webp"
    );
...
export function LoadLanguage(scene) {
    ...
    scene.load.image(
        "home_language_bg",
        assetsBaseUrl + "home_2/home_language/home_language_bg.webp"
    );

    scene.load.image(
        "home_language_tick",
        assetsBaseUrl + "home_2/home_language/home_language_tick.webp"
    );

    scene.load.image(
        "home_language_en",
        assetsBaseUrl + "home_2/home_language/home_language_en.webp"
    );

    scene.load.image(
        "home_language_vi",
        assetsBaseUrl + "home_2/home_language/home_language_vi.webp"
    );

    scene.load.image(
        "home_language_ru",
        assetsBaseUrl + "home_2/home_language/home_language_ru.webp"
    );

    scene.load.image(
        "home_language_cn",
        assetsBaseUrl + "home_2/home_language/home_language_cn.webp"
    );

    scene.load.image(
        "home_language_jp",
        assetsBaseUrl + "home_2/home_language/home_language_jp.webp"
    );

    scene.load.image(
        "home_language_kr",
        assetsBaseUrl + "home_2/home_language/home_language_kr.webp"
    );

    scene.load.image(
        "home_language_in",
        assetsBaseUrl + "home_2/home_language/home_language_in.webp"
    );

    scene.load.image(
        "home_language_de",
        assetsBaseUrl + "home_2/home_language/home_language_de.webp"
    );
}
...
export function LoadDaily(scene) {
    ...
    scene.load.image(
        "home_daily_bg",
        assetsBaseUrl + "home_2/home_daily/home_daily_bg.webp"
    );

    scene.load.image(
        "home_daily_btn_close",
        assetsBaseUrl + "home_2/home_daily/home_daily_btn_close.webp"
    );

    scene.load.image(
        "home_daily_item_btn_check",
        assetsBaseUrl + "home_2/home_daily/home_daily_item_btn_check.webp"
    );

    scene.load.image(
        "home_daily_item_checked",
        assetsBaseUrl + "home_2/home_daily/home_daily_item_checked.webp"
    );

    scene.load.image(
        "home_daily_item_reward_bg",
        assetsBaseUrl + "home_2/home_daily/home_daily_item_reward_bg.webp"
    );
}
...
export function LoadHomeBattle(scene) {
    ...
    scene.load.image(
        "home_battle_btn",
        assetsBaseUrl + "home_2/home_battle/home_battle_btn.webp"
    );

    scene.load.image(
        "home_battle_btn_replay",
        assetsBaseUrl + "home_2/home_battle/home_battle_btn_replay.webp"
    );

    scene.load.image(
        "home_battle_btn_lock",
        assetsBaseUrl + "home_2/home_battle/home_battle_btn_lock.webp"
    );

    scene.load.image(
        "home_battle_top_icon",
        assetsBaseUrl + "home_2/home_battle/home_battle_top_icon.webp"
    );

    //load battle
    scene.load.image(
        "home_battle_btn_battle",
        assetsBaseUrl + "home_2/home_battle/home_battle_btn_battle.webp"
    );

    scene.load.image(
        "home_battle_item_bg_campain",
        assetsBaseUrl + "home_2/home_battle/home_battle_item_bg_campain.webp"
    );

    scene.load.image(
        "home_battle_item_bg_boss",
        assetsBaseUrl + "home_2/home_battle/home_battle_item_bg_boss.webp"
    );

    //load campain
    scene.load.image(
        "home_battle_campaign_bg",
        assetsBaseUrl + "home_2/home_battle/home_battle_campaign_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_battle/home_battle_multiplayer_bg.webp"
    );

    //load boss
    scene.load.image(
        "home_battle_btn_boss",
        assetsBaseUrl + "home_2/home_battle/home_battle_btn_boss.webp"
    );
...
export function LoadCharacterInventory(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_team_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_btn_team.webp"
    );

    scene.load.image(
        "home_character_btn_piece",
        assetsBaseUrl + "home_2/home_character/home_character_btn_piece.webp"
    );

    scene.load.image(
        "home_character_btn_playtest",
        assetsBaseUrl + "home_2/home_character/home_character_btn_playtest.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_filter_btn_c.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_filter_btn_b.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_filter_btn_a.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_filter_btn_s.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_option_up.webp"
    );

    scene.load.image(
        "home_character_option_btn_0",
        assetsBaseUrl + "home_2/home_character/home_character_option_btn_0.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_option_btn_1.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_extract_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_upgrade_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_upgrade_tick.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_character/home_character_piece_bg.webp"
    );
...
export function LoadShareItemCard(scene) {
    scene.load.image(
        "share_item_card_bg",
        assetsBaseUrl + "share_2/share_item_card/share_item_card_bg.webp"
    );

    scene.load.image(
        "share_item_card_bg_2",
        assetsBaseUrl + "share_2/share_item_card/share_item_card_bg_2.webp"
    );
}
...
export function LoadEarn(scene) {
    ...
    scene.load.image(
        "home_earn_bg",
        assetsBaseUrl + "home_2/home_earn/home_earn_bg.webp"
    );

    scene.load.image(
        "home_earn_btn_mint",
        assetsBaseUrl + "home_2/home_earn/home_earn_btn_mint.webp"
    );

    scene.load.image(
        "home_earn_cat_button",
        assetsBaseUrl + "home_2/home_earn/home_earn_cat_button.webp"
    );

    scene.load.image(
        "home_earn_btn_wallet",
        assetsBaseUrl + "home_2/home_earn/home_earn_btn_wallet.webp"
    );

    scene.load.image(
        "home_earn_wallet_icon_0",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_icon_0.webp"
    );

    scene.load.image(
        "home_earn_wallet_icon_1",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_icon_1.webp"
    );

    scene.load.image(
        "home_earn_wallet_icon_2",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_icon_2.webp"
    );

    scene.load.image(
        "home_earn_wallet_icon_3",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_icon_3.webp"
    );

    scene.load.image(
        "home_earn_wallet_icon_4",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_icon_4.webp"
    );

    scene.load.image(
        "home_earn_wallet_icon_5",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_icon_5.webp"
    );

    scene.load.image(
        "home_earn_wallet_label_0",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_label_0.webp"
    );

    scene.load.image(
        "home_earn_wallet_label_1",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_label_1.webp"
    );

    scene.load.image(
        "home_earn_wallet_popup_bg",
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_popup_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_earn/home_earn_chip_to_msci_popup_bg.webp"
    );

    scene.load.image(
        "home_earn_chip_to_msci_btn",
        assetsBaseUrl + "home_2/home_earn/home_earn_chip_to_msci_btn.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_earn/home_earn_msci_view_popup_bg.webp"
    );
    scene.load.image(
        "home_earn_msci_view_btn_0",
        assetsBaseUrl + "home_2/home_earn/home_earn_msci_view_btn_0.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_select_popup_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_earn/home_earn_wallet_sui_guide_bg.webp"
    );
...
export function LoadNeuralink(scene) {
    scene.load.image(
        "home_neuralink_bg",
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_bg.webp"
    );

    //upgrade
    scene.load.image(
        "home_neuralink_upgrade_bg",
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_upgrade_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_btn_drone.webp"
    );

    scene.load.image(
        "home_neuralink_btn_suit",
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_btn_suit.webp"
    );

    scene.load.image(
        "home_neuralink_btn_0",
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_btn_0.webp"
    );

    scene.load.image(
        "home_neuralink_btn_1",
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_btn_1.webp"
    );

    //upgrade detail
    scene.load.image(
        "home_neuralink_detail_bg",
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_detail_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_neuralink/home_neuralink_upgrade_btn.webp"
    );
}
...
export function LoadLobby(scene) {
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_close_beta.webp"
    );

    scene.load.image(
        "home_lobby_close_beta_text",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_close_beta_text.webp"
    );

    scene.load.image(
        "home_lobby_close_beta_btn",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_close_beta_btn.webp"
    );
    ...
    scene.load.image(
        "home_lobby_bg",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_bg.webp?v=" + Date.now()
    );

    scene.load.image(
        "home_lobby_bg_footer",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_bg_footer.webp"
    );

    scene.load.image(
        "home_lobby_daily_chip_reward_bg",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_daily_chip_reward_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_notification.webp"
    );

    scene.load.image(
        "home_lobby_btn_notification_new",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_notification_new.webp"
    );

    scene.load.image(
        "home_lobby_btn_audio_off",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_audio_off.webp"
    );

    scene.load.image(
        "home_lobby_btn_audio_on",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_audio_on.webp"
    );

    scene.load.image(
        "home_lobby_btn_battle",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_battle.webp"
    );

    scene.load.image(
        "home_lobby_btn_character",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_character.webp"
    );

    scene.load.image(
        "home_lobby_btn_tutorial",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_tutorial.webp"
    );

    scene.load.image(
        "home_lobby_btn_center_market",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_center_market.webp"
    );

    scene.load.image(
        "home_lobby_btn_reward",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_reward.webp"
    );

    scene.load.image(
        "home_lobby_btn_gacha",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_gacha.webp"
    );

    scene.load.image(
        "home_lobby_btn_wallet",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_wallet.webp"
    );

    scene.load.image(
        "home_lobby_btn_guild",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_guild.webp"
    );

    scene.load.image(
        "home_lobby_btn_neuralink",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_neuralink.webp"
    );

    scene.load.image(
        "home_lobby_btn_inventory",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_inventory.webp"
    );

    scene.load.image(
        "home_lobby_btn_shop",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_shop.webp"
    );

    scene.load.image(
        "home_lobby_btn_daily",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_daily.webp"
    );

    scene.load.image(
        "home_lobby_btn_language",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_language.webp"
    );

    scene.load.image(
        "home_lobby_btn_msci",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_msci.webp"
    );

    scene.load.image(
        "home_lobby_btn_code",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_code.webp"
    );

    scene.load.image(
        "home_lobby_btn_playtest",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_playtest.webp"
    );

    scene.load.image(
        "home_lobby_btn_left",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_left.webp"
    );

    scene.load.image(
        "home_lobby_btn_right",
        assetsBaseUrl + "home_2/home_lobby/home_lobby_btn_right.webp"
    );
}
...
export function LoadFirstMissions(scene) {
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_first_missions/home_first_missions_bg.webp"
    );
...
export function LoadMuskPack(scene) {
    ...
    scene.load.image(
        "home_musk_buy_btn",
        assetsBaseUrl + "home_2/home_musk/home_musk_buy_btn.webp"
    );

    scene.load.image(
        "home_musk_pack_bg",
        assetsBaseUrl + "home_2/home_musk/home_musk_pack_bg.webp"
    );

    scene.load.image(
        "home_musk_title",
        assetsBaseUrl + "home_2/home_musk/home_musk_title.webp"
    );
}
...
export function LoadItem(scene) {
    ...
    scene.load.image("item_chip", assetsBaseUrl + "item/item_chip.webp");

    scene.load.image("item_musk", assetsBaseUrl + "item/item_musk.webp");

    scene.load.image("item_msci", assetsBaseUrl + "item/item_msci.webp");

    scene.load.image(
        "item_character_box",
        assetsBaseUrl + "item/item_character_box.webp"
    );

    scene.load.image(
        "item_character_c_box",
        assetsBaseUrl + "item/item_character_c_box.webp"
    );

    scene.load.image(
        "item_character_c_box_david",
        assetsBaseUrl + "item/item_character_c_box_david.webp"
    );

    scene.load.image(
        "item_character_c_box_henry",
        assetsBaseUrl + "item/item_character_c_box_henry.webp"
    );

    scene.load.image(
        "item_character_c_box_marcus",
        assetsBaseUrl + "item/item_character_c_box_marcus.webp"
    );

    scene.load.image(
        "item_character_premium_box",
        assetsBaseUrl + "item/item_character_premium_box.webp"
    );

    scene.load.image(
        "item_character_piece_box",
        assetsBaseUrl + "item/item_character_piece_box.webp"
    );

    //c
    scene.load.image(
        "item_fragment_david",
        assetsBaseUrl + "item/item_fragment_david.webp"
    );
    scene.load.image(
        "item_fragment_henry",
        assetsBaseUrl + "item/item_fragment_henry.webp"
    );
    scene.load.image(
        "item_fragment_marcus",
        assetsBaseUrl + "item/item_fragment_marcus.webp"
    );

    //b
    scene.load.image(
        "item_fragment_anna",
        assetsBaseUrl + "item/item_fragment_anna.webp"
    );
    scene.load.image(
        "item_fragment_julia",
        assetsBaseUrl + "item/item_fragment_julia.webp"
    );
    scene.load.image(
        "item_fragment_fiona",
        assetsBaseUrl + "item/item_fragment_fiona.webp"
    );

    //a
    scene.load.image(
        "item_fragment_victoria",
        assetsBaseUrl + "item/item_fragment_victoria.webp"
    );
    scene.load.image(
        "item_fragment_elizabeth",
        assetsBaseUrl + "item/item_fragment_elizabeth.webp"
    );
    scene.load.image(
        "item_fragment_alexandra",
        assetsBaseUrl + "item/item_fragment_alexandra.webp"
    );

    //s
    scene.load.image(
        "item_fragment_akane",
        assetsBaseUrl + "item/item_fragment_akane.webp"
    );
    scene.load.image(
        "item_fragment_alice",
        assetsBaseUrl + "item/item_fragment_alice.webp"
    );
    scene.load.image(
        "item_fragment_caitlyn",
        assetsBaseUrl + "item/item_fragment_caitlyn.webp"
    );

    scene.load.image(
        "item_msci_memory",
        assetsBaseUrl + "item/item_msci_memory.webp"
    );

    scene.load.image(
        "item_doge_energy",
        assetsBaseUrl + "item/item_doge_energy.webp"
    );

    scene.load.image(
        "item_doge_shield",
        assetsBaseUrl + "item/item_doge_shield.webp"
    );

    scene.load.image(
        "item_blind_bag",
        assetsBaseUrl + "item/item_blind_bag.webp"
    );

    scene.load.image(
        "item_boss_world_box",
        assetsBaseUrl + "item/item_boss_world_box.webp"
    );

    scene.load.image(
        "item_boss_elite_box",
        assetsBaseUrl + "item/item_boss_elite_box.webp"
    );

    //load neuralink
    scene.load.image(
        "item_neuralink",
        assetsBaseUrl + "item/item_neuralink.webp"
    );

    scene.load.image(
        "item_neuralink_1",
        assetsBaseUrl + "item/item_neuralink_1.webp"
    );

    scene.load.image(
        "item_neuralink_2",
        assetsBaseUrl + "item/item_neuralink_2.webp"
    );

    scene.load.image(
        "item_neuralink_3",
        assetsBaseUrl + "item/item_neuralink_3.webp"
    );

    scene.load.image(
        "item_neuralink_4",
        assetsBaseUrl + "item/item_neuralink_4.webp"
    );

    scene.load.image(
        "item_neuralink_5",
        assetsBaseUrl + "item/item_neuralink_5.webp"
    );

    scene.load.image(
        "item_neuralink_1_e",
        assetsBaseUrl + "item/item_neuralink_1_e.webp"
    );

    scene.load.image(
        "item_neuralink_2_e",
        assetsBaseUrl + "item/item_neuralink_2_e.webp"
    );

    scene.load.image(
        "item_neuralink_3_e",
        assetsBaseUrl + "item/item_neuralink_3_e.webp"
    );

    scene.load.image(
        "item_neuralink_4_e",
        assetsBaseUrl + "item/item_neuralink_4_e.webp"
    );

    scene.load.image(
        "item_neuralink_5_e",
        assetsBaseUrl + "item/item_neuralink_5_e.webp"
    );
}
...
export function LoadAvatars(scene) {
    scene.load.image(
        "home_avatar_bg",
        assetsBaseUrl + "home_2/home_avatar/home_avatar_bg.webp"
    );

    scene.load.image(
        "home_avatar_using",
        assetsBaseUrl + "home_2/home_avatar/home_avatar_using.webp"
    );
    ...
    for (let i = 0; i < 12; i++) {
        scene.load.image(
            `avatar_free_${i}`,
            assetsBaseUrl + `avatar/avatar_free_${i}.webp`
        );
    }
    ...
    scene.load.image(
        "avatar_frame_1",
        assetsBaseUrl + "avatar/avatar_frame/avatar_frame_1.webp"
    );

    scene.load.image(
        "avatar_frame_2",
        assetsBaseUrl + "avatar/avatar_frame/avatar_frame_2.webp"
    );

    scene.load.image(
        "avatar_frame_3",
        assetsBaseUrl + "avatar/avatar_frame/avatar_frame_3.webp"
    );
}
...
export function LoadGameplayTopBar(scene) {
    scene.load.image(
        "gameplay_top_bar_bg",
        assetsBaseUrl + "gameplay/gameplay_top_bar/gameplay_top_bar_bg.webp"
    );
...
export function LoadUserInfo(scene) {
    ...
    scene.load.image(
        "home_user_info_bg",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_bg.webp"
    );

    scene.load.image(
        "home_user_info_btn_account",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_btn_account.webp"
    );

    scene.load.image(
        "home_user_info_btn_network",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_btn_network.webp"
    );

    scene.load.image(
        "home_user_info_btn_rank",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_btn_rank.webp"
    );

    //load account
    scene.load.image(
        "home_user_info_account_bg",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_account_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_user_info/home_user_info_network_bg.webp"
    );

    //load rank
    scene.load.image(
        "home_user_info_rank_bg",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_rank_bg.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_user_info/home_user_info_rank_label.webp"
    );
    ...
    scene.load.image(
        ...
        assetsBaseUrl + "home_2/home_user_info/home_user_info_equip_bg.webp"
    );

    scene.load.image(
        "home_user_info_equip_btn",
        assetsBaseUrl + "home_2/home_user_info/home_user_info_equip_btn.webp"
    );
}
...
export function LoadFriends(scene) {
    scene.load.image(
        "home_friends_bg",
        assetsBaseUrl + "home_2/home_friends/home_friends_bg.webp"
    );

    scene.load.image(
        "home_friends_list_item_bg",
        assetsBaseUrl + "home_2/home_friends/home_friends_list_item_bg.webp"
    );

    scene.load.image(
        "home_friends_btn_0",
        assetsBaseUrl + "home_2/home_friends/home_friends_btn_0.webp"
    );

    scene.load.image(
        "home_friends_btn_add_friend",
        assetsBaseUrl + "home_2/home_friends/home_friends_btn_add_friend.webp"
    );

    scene.load.image(
        "home_friends_btn_1",
        assetsBaseUrl + "home_2/home_friends/home_friends_btn_1.webp"
    );
}
...
export function LoadGuild(scene) {
    scene.load.image(
        "home_guild_bg",
        assetsBaseUrl + "home_2/home_guild/home_guild_bg.webp"
    );

    scene.load.image(
        "home_guild_chat_bg",
        assetsBaseUrl + "home_2/home_guild/home_guild_chat_bg.webp"
    );

    scene.load.image(
        "home_guild_list_item_bg",
        assetsBaseUrl + "home_2/home_guild/home_guild_list_item_bg.webp"
    );

    scene.load.image(
        "home_guild_btn_0",
        assetsBaseUrl + "home_2/home_guild/home_guild_btn_0.webp"
    );

    scene.load.image(
        "home_guild_btn_play",
        assetsBaseUrl + "home_2/home_guild/home_guild_btn_play.webp"
    );

    scene.load.image(
        "home_guild_btn_play_1",
        assetsBaseUrl + "home_2/home_guild/home_guild_btn_play_1.webp"
    );

    scene.load.image(
        "home_guild_btn_1",
        assetsBaseUrl + "home_2/home_guild/home_guild_btn_1.webp"
    );

    scene.load.image(
        "home_guild_avatar_using",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar_using.webp"
    );
}
...
export function LoadGuildAvatars(scene) {
    scene.load.image(
        "GA1",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA1.webp"
    );

    scene.load.image(
        "GA2",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA2.webp"
    );

    scene.load.image(
        "GA3",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA3.webp"
    );

    scene.load.image(
        "GA4",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA4.webp"
    );

    scene.load.image(
        "GA5",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA5.webp"
    );

    scene.load.image(
        "GA6",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA6.webp"
    );

    scene.load.image(
        "GA7",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA7.webp"
    );

    scene.load.image(
        "GA8",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA8.webp"
    );

    scene.load.image(
        "GA9",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA9.webp"
    );

    scene.load.image(
        "GA10",
        assetsBaseUrl + "home_2/home_guild/home_guild_avatar/GA10.webp"
    );
}
...
export function LoadVip(scene) {
    scene.load.image(
        "home_vip_bg",
        assetsBaseUrl + "home_2/home_vip/home_vip_bg.webp"
    );

    scene.load.image(
        "home_vip_title",
        assetsBaseUrl + "home_2/home_vip/home_vip_title.webp"
    );

    scene.load.image(
        "home_vip_btn",
        assetsBaseUrl + "home_2/home_vip/home_vip_btn.webp"
    );

    scene.load.image(
        "home_vip_icon",
        assetsBaseUrl + "home_2/home_vip/home_vip_icon.webp"
    );

    scene.load.image(
        "home_vip_icon_1",
        assetsBaseUrl + "home_2/home_vip/home_vip_icon_1.webp"
    );

    scene.load.image(
        "home_vip_icon_2",
        assetsBaseUrl + "home_2/home_vip/home_vip_icon_2.webp"
    );

    scene.load.image(
        "home_vip_icon_3",
        assetsBaseUrl + "home_2/home_vip/home_vip_icon_3.webp"
    );
}
...
export function LoadMapById(scene, mapId) {
    switch (mapId) {
        case 0:
            ...
            scene.load.image(
                "map_0_bg",
                assetsBaseUrl + "gameplay/map/map_0/map_0_bg.webp"
            );
            scene.load.image(
                "map_0_obstacle_0_wall",
                assetsBaseUrl + "gameplay/map/map_0/map_0_obstacle_0_wall.webp"
            );
            break;
        case 1:
            //Load map 1 space
            scene.load.image(
                "map_1_bg",
                assetsBaseUrl + "gameplay/map/map_1/map_1_bg.webp"
            );
            scene.load.image(
                "map_1_obstacle_0_wall",
                assetsBaseUrl + "gameplay/map/map_1/map_1_obstacle_0_wall.webp"
            );
            break;
        case 2:
            //Load map 2 mars
            scene.load.image(
                "map_2_bg",
                assetsBaseUrl + "gameplay/map/map_2/map_2_bg.webp"
            );
            scene.load.image(
                "map_2_obstacle_0_wall",
                assetsBaseUrl + "gameplay/map/map_2/map_2_obstacle_0_wall.webp"
            );
            break;
        case 3:
            //Load map boss 0
...
export function CreatePlayerDictionary() {
    playerSpineDictionary = {
        ...
        david: {
            ...
            spineUI: {
                key: "david_spine_ui",
                url: assetsBaseUrl + "gameplay/player/david/player_2_ui",
            },
            spineGameplay: {
                key: "david_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/david/player_2_gameplay",
            },
        },
        davidsc: {
            UICardInventory: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/davidsc/david_01_ui",
            },
            spineGameplay: {
                key: "davidsc_spine_gameplay",
                url:
                    assetsBaseUrl + "gameplay/player/davidsc/david_01_gameplay",
            },
        },
        henry: {
            UICardInventory: {
            ...
            spineUI: {
                key: "henry_spine_ui",
                url: assetsBaseUrl + "gameplay/player/henry/player_5_ui",
            },
            spineGameplay: {
                key: "henry_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/henry/player_5_gameplay",
            },
        },
        henrysc: {
            UICardInventory: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/henrysc/player_14_ui",
            },
            spineGameplay: {
        ...
        marcus: {
            ...
            spineUI: {
                key: "marcus_spine_ui",
                url: assetsBaseUrl + "gameplay/player/marcus/player_28_ui",
            },
            spineGameplay: {
                key: "marcus_spine_gameplay",
                url:
                    assetsBaseUrl + "gameplay/player/marcus/player_28_gameplay",
            },
        },
        marcussc: {
            UICardInventory: {
        ...
        anna: {
            ...
            spineUI: {
                key: "anna_spine_ui",
                url: assetsBaseUrl + "gameplay/player/anna/player_0_ui",
            },
            spineGameplay: {
                key: "anna_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/anna/player_0_gameplay",
            },
        },
        annasb: {
            UICardInventory: {
            ...
            spineUI: {
                key: "annasb_spine_ui",
                url: assetsBaseUrl + "gameplay/player/annasb/player_16_ui",
            },
            spineGameplay: {
                key: "annasb_spine_gameplay",
                url:
                    assetsBaseUrl + "gameplay/player/annasb/player_16_gameplay",
            },
        },
        julia: {
            UICardInventory: {
            ...
            spineUI: {
                key: "julia_spine_ui",
                url: assetsBaseUrl + "gameplay/player/julia/player_4_ui",
            },
            spineGameplay: {
                key: "julia_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/julia/player_4_gameplay",
            },
        },
        juliasb: {
            UICardInventory: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/juliasb/player_20_ui",
            },
            spineGameplay: {
        ...
        fiona: {
            ...
            spineUI: {
                key: "fiona_spine_ui",
                url: assetsBaseUrl + "gameplay/player/fiona/player_6_ui",
            },
            spineGameplay: {
                key: "fiona_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/fiona/player_6_gameplay",
            },
        },
        fionasb: {
            UICardInventory: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/fionasb/player_21_ui",
            },
            spineGameplay: {
        ...
        victoria: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/victoria/player_1_ui",
            },
            spineGameplay: {
        ...
        victoriasa: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/victoriasa/player_22_ui",
            },
            spineGameplay: {
        ...
        elizabeth: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/elizabeth/player_8_ui",
            },
            spineGameplay: {
        ...
        elizabethsa: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/elizabethsa/player_23_ui",
            },
            spineGameplay: {
        ...
        alexandra: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/alexandra/player_7_ui",
            },
            spineGameplay: {
        ...
        alexandrasa: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/alexandrasa/player_24_ui",
            },
            spineGameplay: {
        ...
        akane: {
            ...
            spineUI: {
                key: "akane_spine_ui",
                url: assetsBaseUrl + "gameplay/player/akane/player_10_ui",
            },
            spineGameplay: {
                key: "akane_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/akane/player_10_gameplay",
            },
        },
        alice: {
            UICardInventory: {
            ...
            spineUI: {
                key: "alice_spine_ui",
                url: assetsBaseUrl + "gameplay/player/alice/player_11_ui",
            },
            spineGameplay: {
                key: "alice_spine_gameplay",
                url: assetsBaseUrl + "gameplay/player/alice/player_11_gameplay",
            },
        },
        caitlyn: {
            UICardInventory: {
            ...
            spineUI: {
                ...
                url: assetsBaseUrl + "gameplay/player/caitlyn/player_13_ui",
            },
            spineGameplay: {
...
export function LoadEnemy(scene) {
    ...
    scene.load.spine(
        "gameplay_enemy_3",
        assetsBaseUrl + "gameplay/enemy/enemy_3/play_drone_1.json",
        assetsBaseUrl + "gameplay/enemy/enemy_3/play_drone_1.atlas",
        true
    );
    ...
    scene.load.spine(
        "enemy_drone_3",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_3/play_drone_2.json",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_3/play_drone_2.atlas",
        true
    );
    ...
    scene.load.spine(
        "enemy_drone_4",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_4/play_drone_3.json",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_4/play_drone_3.atlas",
        true
    );
    ...
    scene.load.spine(
        "enemy_drone_5",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_5/play_drone_4.json",
        assetsBaseUrl + "gameplay/enemy/enemy_drone_5/play_drone_4.atlas",
        true
    );

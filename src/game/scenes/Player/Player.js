...
class Player {
    constructor(scene, x, y, _id, playerId, explosionPool, strikePool) {
        this.scene = scene;
        ...
        this.unlockedPlayer = centerData.getUnlockedPlayerById(this._id);
    ...
    takeShoot(hitPosition) {
        ...
        this.scene.time.delayedCall(125, () => {
            let tweenDelay = this.unlockedPlayer.properties.attackDelay - 125;
            if (this.unlockedPlayer.properties.attackDelay <= 0) {
                tweenDelay = 125;
            }
        ...
        this.scene.time.delayedCall(
            this.unlockedPlayer.properties.attackDelay,
            () => {
                this.isCanAttack = true;

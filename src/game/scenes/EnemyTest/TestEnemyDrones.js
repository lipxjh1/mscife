...
export function EnemyDroneIdToKeySpine(enemyId) {
    // Trong chế độ test, luôn sử dụng enemy_drone_0 đã được tải trong "earth" range
    return "enemy_drone_0";
}

class TestEnemyDrones {
    constructor(
        scene,
        id,
        enemyType,
...
export default TestEnemyDrones; // Đảm bảo sử dụng export default

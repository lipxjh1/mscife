import PlayTestMap from "./PlayTestMap.js";

class PlayTestMapEarth extends PlayTestMap {
...
// Hàm tạo PlayTestMapEarth
export function CreateMap(scene, id) {
    return new PlayTestMapEarth(scene, id);
}

export default PlayTestMapEarth;
